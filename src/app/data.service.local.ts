...
export class DataService {
  ...
  constructor() {
    ...
    capacity1.capacity = 3;

    const capacity2 = new LayoutCapacity();
    capacity2.layout = Layout.BOARD;
    capacity2.capacity = 31;
    ...
    booking1.title = 'Super Percy';
    booking1.date = formatDate(new Date(), 'yyyy-MM-dd', 'en-GB');
    booking1.startTime = '12:00';
    ...
    booking2.title = 'Super Percy';
    booking2.date = formatDate(new Date(), 'yyyy-MM-dd', 'en-GB');
    booking2.startTime = '22:00';
    booking2.endTime = '23:00';
